...
public:
	...
	unsigned char                                      UnknownData_GEHJ[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9JLJ[0x18];                                    // 0x0110(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_J0AN[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
