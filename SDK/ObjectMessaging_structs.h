...
{
	unsigned char                                      UnknownData_8PN5[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_W3SN[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8ME7[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UStruct*                                     EventType;                                                 // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_UVT8[0x38];                                    // 0x0010(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3NFC[0xA0];                                    // 0x0000(0x00A0) MISSED OFFSET (PADDING)
