...
{
public:
	unsigned char                                      UnknownData_1YZH[0x8];                                     // 0x05E0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KKM1[0x1C];                                    // 0x05FC(0x001C) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_1J6Z[0x8];                                     // 0x0618(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_VZKG[0x50];                                    // 0x0630(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QXG8[0xC];                                     // 0x0634(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3N6W[0x70];                                    // 0x00C8(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZFT4[0x5];                                     // 0x014B(0x0005) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_62PA[0xF8];                                    // 0x03D0(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_07SV[0x8];                                     // 0x0500(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KLDI[0x3];                                     // 0x050D(0x0003) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Y23K[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HW1J[0x48];                                    // 0x00D8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C8Q6[0x2];                                     // 0x0126(0x0002) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PUEQ[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (PADDING)
