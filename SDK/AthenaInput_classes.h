...
{
public:
	unsigned char                                      UnknownData_VXFO[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0VMW[0xB0];                                    // 0x0028(0x00B0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JAS7[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_EUK8[0x58];                                    // 0x0030(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4IFM[0x50];                                    // 0x0028(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HLSE[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6YDS[0x8];                                     // 0x05C8(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_M6ON[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
