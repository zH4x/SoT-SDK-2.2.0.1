...
{
public:
	unsigned char                                      UnknownData_85NM[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_10XW[0x10];                                    // 0x0160(0x0010) MISSED OFFSET (PADDING)
