...
{
public:
	unsigned char                                      UnknownData_P243[0x8];                                     // 0x03D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_37XM[0x2];                                     // 0x03E6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D2YR[0x2];                                     // 0x03FA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5IMD[0x4];                                     // 0x0404(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DE8Y[0x3C];                                    // 0x045C(0x003C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9UAZ[0x38];                                    // 0x0028(0x0038) MISSED OFFSET (PADDING)
