...
struct FHangoutSpotParams
{
	...
	unsigned char                                      UnknownData_TF40[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPetDangerHearingThreat
{
	...
	unsigned char                                      UnknownData_BVCO[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPetFeedingAnimationData
{
	...
	unsigned char                                      UnknownData_UM3U[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHangoutSpotPosition
{
	...
	unsigned char                                      UnknownData_KKHX[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T5CK[0x6];                                     // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class APawn*                                       Occupier;                                                  // 0x0048(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_PO4P[0x10];                                    // 0x0050(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HGIY[0x2];                                     // 0x0062(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EPA2[0xE];                                     // 0x0072(0x000E) MISSED OFFSET (PADDING)
...
struct FPetRelationship
{
	...
	unsigned char                                      UnknownData_1O8C[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
struct FReactStateMapping
{
	...
	unsigned char                                      UnknownData_RSNO[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MN2Z[0x4];                                     // 0x00C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWieldablePetDropTimeout
{
	...
	unsigned char                                      UnknownData_53QN[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWieldablePetFoodSourceEntry
{
	...
	unsigned char                                      UnknownData_FZJW[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FWieldablePetHungerAnimationData
{
	...
	unsigned char                                      UnknownData_R96V[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPetTurnToFaceData
{
	...
	unsigned char                                      UnknownData_940G[0xC];                                     // 0x0014(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PSNJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4DQS[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventPetReactedToFood : public FEventPetFoodBase
{
	...
	unsigned char                                      UnknownData_HUGE[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CBAV[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_V4MG[0x2];                                     // 0x0000(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UDTF[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JW9P[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UXQM[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OHCV[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FEventWieldablePetPutOnPerch
{
	...
	unsigned char                                      UnknownData_DCN6[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VYD7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventPetReactBegun
{
	...
	unsigned char                                      UnknownData_YLW4[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FPetBaseTelemetryFragment
{
	...
	unsigned char                                      UnknownData_HUBL[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWieldablePetPutOnPerchTelemetryEvent
{
	...
	uint32_t                                           HangoutSpotIndex;                                          // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_56L5[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_BALS[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FPetReactedToFoodTelemetryEvent
{
	...
	unsigned char                                      UnknownData_6M4C[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FPetReactedTelemetryEvent
{
	...
	unsigned char                                      UnknownData_D8PK[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_33O0[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XGNG[0xC];                                     // 0x0000(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EM1O[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ICTI[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FPetDespawnActionStateParams
{
	...
	unsigned char                                      UnknownData_XDKR[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FPetSpawnActionStateParams
{
	...
	unsigned char                                      UnknownData_0ES9[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
