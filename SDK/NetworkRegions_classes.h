...
{
public:
	unsigned char                                      UnknownData_CLMR[0x90];                                    // 0x0028(0x0090) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_AT7C[0x20];                                    // 0x03F0(0x0020) MISSED OFFSET (PADDING)
