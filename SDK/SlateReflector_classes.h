...
public:
	...
	unsigned char                                      UnknownData_X4Y2[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_5K25[0x18];                                    // 0x0080(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ULJ4[0x20];                                    // 0x0080(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       CachedWidgetVisibilityText;                                // 0x00B8(0x0018) ELEMENT_SIZE_MISMATCH
	unsigned char                                      UnknownData_E2SA[0x20];                                    // 0x00B8(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       CachedWidgetReadableLocation;                              // 0x00F0(0x0018) ELEMENT_SIZE_MISMATCH
	unsigned char                                      UnknownData_JVOG[0x20];                                    // 0x00F0(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_CX71[0x4];                                     // 0x014C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6E33[0x7];                                     // 0x0191(0x0007) MISSED OFFSET (PADDING)
