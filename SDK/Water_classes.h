...
{
public:
	unsigned char                                      UnknownData_JLZ8[0x28];                                    // 0x0418(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HF2L[0x8];                                     // 0x03D8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RDRC[0x10];                                    // 0x03D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MBSQ[0x50];                                    // 0x03F8(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_X3AO[0x8];                                     // 0x0588(0x0008) Fix Super Size
	unsigned char                                      UnknownData_7VSW[0x10];                                    // 0x0590(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_388E[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CJOG[0x28];                                    // 0x00C8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_Z17E[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WPXD[0x8];                                     // 0x05A8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_ZKEC[0x20];                                    // 0x05B0(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_W4T1[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MXVD[0x7];                                     // 0x0109(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T0GY[0x4];                                     // 0x0124(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QPI9[0x18];                                    // 0x0140(0x0018) MISSED OFFSET (PADDING)
