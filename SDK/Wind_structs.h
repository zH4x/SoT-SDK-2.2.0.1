...
struct FWindZoneParams
{
	...
	unsigned char                                      UnknownData_WGSI[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XDOY[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4FRD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
