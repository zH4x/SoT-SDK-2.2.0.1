...
{
	unsigned char                                      UnknownData_X2NA[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6MOO[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_X9WB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
