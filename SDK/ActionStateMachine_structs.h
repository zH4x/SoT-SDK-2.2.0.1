...
{
	unsigned char                                      UnknownData_8A5D[0x40];                                    // 0x0000(0x0040) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6LQ3[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FResetStateMachineRpc
{
	...
	unsigned char                                      UnknownData_SRXZ[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_LH5Z[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7P70[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FTestActionStateSerialisableData : public FActionStateSerialisableData
{
	...
	unsigned char                                      UnknownData_RCCV[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FActionStatePriorityRelationship
{
	...
	unsigned char                                      UnknownData_4USK[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5Y0G[0xA0];                                    // 0x0000(0x00A0) MISSED OFFSET (PADDING)
...
struct FActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_S18A[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
struct FInnerTestStruct
{
	...
	unsigned char                                      UnknownData_MLMX[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTestActionStateConstructionInfo : public FActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_UZLP[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FTestActionStateConstructionInfoWithInner : public FActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_WSNG[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_MOET[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_Z5XA[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5NOJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YNQD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FTestActionStateMessage : public FActionStateMessage
{
	...
	unsigned char                                      UnknownData_8EB4[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FTestActorActionStateConstructionInfo : public FActorActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_1YL3[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
