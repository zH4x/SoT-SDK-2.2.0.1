...
// 0x0211 (FullSize[0x0851] - InheritedSize[0x0640])
...
public:
	...
	bool                                               InUse;                                                     // 0x0850(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass BP_Anim_TT_QuestBook.BP_Anim_TT_QuestBook_C");
		return ptr;
	}
