...
{
public:
	unsigned char                                      UnknownData_9H0K[0x8];                                     // 0x0440(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OBID[0x1D];                                    // 0x0473(0x001D) MISSED OFFSET (PADDING)
