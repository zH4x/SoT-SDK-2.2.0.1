...
struct FAIShipBattleParams
{
	...
	unsigned char                                      UnknownData_X8CP[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_CX9S[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FTrackingNoiseGenerator
{
	...
	unsigned char                                      UnknownData_W2BK[0xC];                                     // 0x000C(0x000C) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterParamsSpawnerData
{
	...
	unsigned char                                      UnknownData_VYZ2[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipContextDescDamageParams
{
	...
	unsigned char                                      UnknownData_TGN3[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SKED[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipCrewAmmoType
{
	...
	unsigned char                                      UnknownData_JP6I[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipCrewFormType
{
	...
	unsigned char                                      UnknownData_DWFJ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SG25[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedSpawnOffset
{
	...
	unsigned char                                      UnknownData_XP45[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedSpawnDirection
{
	...
	float                                              Weight;                                                    // 0x0008(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_HTSB[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FWeightedSpawnOffset>                SpawnOffsets;                                              // 0x0010(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	unsigned char                                      UnknownData_OGJV[0x90];                                    // 0x0020(0x0090) MISSED OFFSET (PADDING)
...
struct FRelativeSpawnLocationGeneratorParams
{
	...
	unsigned char                                      UnknownData_FOE7[0x90];                                    // 0x0010(0x0090) MISSED OFFSET (PADDING)
...
struct FAIShipSizeLimit
{
	...
	unsigned char                                      UnknownData_FW0H[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIShipWeightedSize
{
	...
	unsigned char                                      UnknownData_7ZKP[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipEncounterBattleGenerationParams
{
	...
	unsigned char                                      UnknownData_N4NB[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFeatureLockedAIShipEncounterBattleGenerationParams
{
	...
	unsigned char                                      UnknownData_WSP4[0x10];                                    // 0x0068(0x0010) MISSED OFFSET (PADDING)
...
struct FAIShipBattleEncounterDescGenerationParams
{
	...
	unsigned char                                      UnknownData_YMU2[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FText                                       Name;                                                      // 0x0000(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_AKVP[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       SkellyCrewName;                                            // 0x0038(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_TDVF[0x20];                                    // 0x0038(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_YFB1[0x6];                                     // 0x0072(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipDespawnedEvent
{
	...
	unsigned char                                      UnknownData_5R1T[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FAIShipSpawnedEvent
{
	...
	unsigned char                                      UnknownData_5110[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterCompleteNetEvent : public FBoxedRpc
{
	...
	unsigned char                                      UnknownData_FKKR[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterRevealNetEvent : public FBoxedRpc
{
	...
	unsigned char                                      UnknownData_SKWC[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterNotification
{
	...
	unsigned char                                      UnknownData_Y6L4[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_AZ7T[0x20];                                    // 0x0040(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_AJK6[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterZoneEnteredNetworkEvent : public FNetworkEventStruct
{
	...
	unsigned char                                      UnknownData_UHFY[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIShipDamagedTelemetryEvent
{
	...
	unsigned char                                      UnknownData_G7N2[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LM8T[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FAIShipDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_EJN2[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FAIShipSpawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_N46X[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FWeightedAIShipCrewFormType
{
	...
	unsigned char                                      UnknownData_4TDZ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	int                                                Weight;                                                    // 0x0000(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_ZJRT[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipEncounterParams
{
	...
	unsigned char                                      UnknownData_NNWC[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipGenerationParams
{
	...
	unsigned char                                      UnknownData_LET4[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1FQR[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
