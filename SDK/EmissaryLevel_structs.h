...
struct FLightVisualisation
{
	...
	unsigned char                                      UnknownData_KS5Y[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEmissaryLevelData
{
	...
	unsigned char                                      UnknownData_3HXR[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_15KV[0x4];                                     // 0x0028(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FEmissaryEventAward
{
	...
	unsigned char                                      UnknownData_SSXX[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEmissaryGameEventsReward
{
	...
	unsigned char                                      UnknownData_4HZN[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FEmissaryCompanyActionReward
{
	...
	unsigned char                                      UnknownData_PXBM[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEmissaryKillPlayerReward
{
	...
	unsigned char                                      UnknownData_OMPP[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_H23Z[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SUXP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FUpdateEmissaryValueForCompany
{
	...
	unsigned char                                      UnknownData_P7HL[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDeactivateEmissaryForCrew
{
	...
	unsigned char                                      UnknownData_SCWI[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_B3CI[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8PV7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEmissaryRoleplayActionTelemetryEvent
{
	...
	unsigned char                                      UnknownData_L47W[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEmissarySessionEndTelemetryEvent
{
	...
	unsigned char                                      UnknownData_V62V[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G794[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_254K[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
