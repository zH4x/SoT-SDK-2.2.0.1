...
public:
	...
	unsigned char                                      UnknownData_595J[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_X4KO[0x18];                                    // 0x0048(0x0018) MISSED OFFSET (PADDING)
