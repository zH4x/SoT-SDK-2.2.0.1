...
public:
	...
	unsigned char                                      UnknownData_RA42[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_95HS[0x3];                                     // 0x0409(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6L90[0x20];                                    // 0x0420(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PW3P[0x10];                                    // 0x0230(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_G0NF[0x8];                                     // 0x00E0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SXN6[0x14];                                    // 0x00FC(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
