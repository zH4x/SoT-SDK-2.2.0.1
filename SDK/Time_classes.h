...
{
public:
	unsigned char                                      UnknownData_UWHV[0x38];                                    // 0x03D0(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTimespan                                   GameWorldTimeOffset;                                       // 0x0408(0x0008) (Edit, ZeroConstructor, Config, DisableEditOnInstance, Protected)
	unsigned char                                      UnknownData_HXAP[0x4];                                     // 0x0410(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q3YZ[0x4];                                     // 0x041C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C7NY[0x4C];                                    // 0x0454(0x004C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FReplicatedAuthoritativeTime                ReplicatedServerTime;                                      // 0x04A0(0x0010) (BlueprintVisible, BlueprintReadOnly, Net, RepNotify)
	unsigned char                                      UnknownData_AIU5[0x30];                                    // 0x04B0(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MS99[0x8];                                     // 0x04E0(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6750[0x8];                                     // 0x04E8(0x0008) MISSED OFFSET (PADDING)
