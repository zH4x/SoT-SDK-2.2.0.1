...
public:
	...
	unsigned char                                      UnknownData_4ZWT[0x58];                                    // 0x00D0(0x0058) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WJR0[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
