...
public:
	...
	unsigned char                                      UnknownData_57YQ[0x3];                                     // 0x00ED(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9T3B[0x4];                                     // 0x00F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GJRL[0x50];                                    // 0x0108(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1RUK[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5IPB[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C2PO[0x50];                                    // 0x03F8(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WT0A[0x38];                                    // 0x0040(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7ZDR[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MBCO[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1625[0x50];                                    // 0x0068(0x0050) MISSED OFFSET (PADDING)
