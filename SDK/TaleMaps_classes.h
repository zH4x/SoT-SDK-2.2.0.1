...
{
public:
	unsigned char                                      UnknownData_FLJZ[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_X5DD[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_H9A4[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_KVKW[0x30];                                    // 0x0078(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9YIG[0x48];                                    // 0x0068(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_J3W2[0x40];                                    // 0x0068(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4ZTC[0x30];                                    // 0x0068(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_UWPF[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (PADDING)
