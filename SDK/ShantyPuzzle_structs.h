...
struct FShantyPuzzleInteractionZoneDefinition
{
	...
	unsigned char                                      UnknownData_FWR5[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_KU3U[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FShantyPuzzleSingleInteractionZoneStopInteractingEvent
{
	...
	unsigned char                                      UnknownData_T2KA[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FShantyPuzzleSingleInteractionZoneUnlockEvent
{
	class AActor*                                      Player;                                                    // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                InteractionZoneIdx;                                        // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_DY0P[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_M899[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
