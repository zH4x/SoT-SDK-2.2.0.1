...
struct FScrapeableDamageSpeedEntry
{
	...
	unsigned char                                      UnknownData_4QOS[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FWatercraftRolloverCorrector
{
	...
	unsigned char                                      UnknownData_7GL4[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FRowboatDamageEffectData
{
	...
	unsigned char                                      UnknownData_XHOW[0xC];                                     // 0x000C(0x000C) MISSED OFFSET (PADDING)
...
struct FOar
{
	...
	unsigned char                                      UnknownData_YHW0[0x28];                                    // 0x0038(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9QHH[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4UVR[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7MYQ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FRowboatMountStateTelemetryEvent
{
	...
	unsigned char                                      UnknownData_PUWF[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FWatercraftDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_31CN[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
