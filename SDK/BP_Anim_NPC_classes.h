...
public:
	...
	unsigned char                                      UnknownData_JWZO[0x3];                                     // 0x1BC1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W1AO[0x3];                                     // 0x1BC9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
