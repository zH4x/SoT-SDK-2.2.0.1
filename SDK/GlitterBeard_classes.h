...
public:
	...
	unsigned char                                      UnknownData_4UAX[0x80];                                    // 0x00E0(0x0080) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MP8D[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M22O[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_364Z[0x48];                                    // 0x00C8(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WOEM[0x28];                                    // 0x03D0(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K3GH[0x4];                                     // 0x040C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_345I[0x22C];                                   // 0x044C(0x022C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M950[0x30];                                    // 0x06A0(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SFEM[0x10];                                    // 0x00D8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<TEnumAsByte<GlitterBeard_EGlitterbeardVFXState>> CurrentStates;                                             // 0x00E8(0x0010) (Net, ZeroConstructor, RepNotify)
	unsigned char                                      UnknownData_712F[0x20];                                    // 0x00F8(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0KS1[0xC];                                     // 0x00E4(0x000C) MISSED OFFSET (PADDING)
