...
struct FClueDestinationToTextIndex
{
	...
	unsigned char                                      UnknownData_FLG5[0x4];                                     // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FClueDestinationChoice
{
	...
	unsigned char                                      UnknownData_9TT4[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FGenderSpecificTextPairings
{
	...
	unsigned char                                      UnknownData_DCS8[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       FeminineClueDestinationDescription;                        // 0x0038(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_4X62[0x20];                                    // 0x0038(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FTextEntryWithLayout
{
	...
	unsigned char                                      UnknownData_CSGD[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMapRadialIconData
{
	...
	unsigned char                                      UnknownData_IYDQ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FExistingNPCToPhasedNPC
{
	...
	unsigned char                                      UnknownData_GX0A[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_JP9M[0x4];                                     // 0x0020(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
