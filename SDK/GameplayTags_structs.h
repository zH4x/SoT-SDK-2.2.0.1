...
struct FGameplayTagQuery
{
	...
	unsigned char                                      UnknownData_MVOA[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_4F0O[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_YTQT[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
struct FGameplayTagTableRow : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_QNMC[0x20];                                    // 0x0010(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
