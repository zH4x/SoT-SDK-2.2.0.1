...
{
public:
	unsigned char                                      UnknownData_FLI1[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TCHD[0xC];                                     // 0x00A4(0x000C) MISSED OFFSET (PADDING)
