...
public:
	...
	unsigned char                                      UnknownData_UA1R[0xAC];                                    // 0x0594(0x00AC) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_01LP[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6U7W[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_880J[0x88];                                    // 0x0498(0x0088) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Q4XM[0x8];                                     // 0x02E8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3IOA[0x8];                                     // 0x0618(0x0008) Fix Super Size
