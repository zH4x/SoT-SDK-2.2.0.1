...
{
public:
	unsigned char                                      UnknownData_5EBO[0x4];                                     // 0x0A1C(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_ZUK7[0x7];                                     // 0x0A31(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
