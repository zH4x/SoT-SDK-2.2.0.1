...
{
public:
	unsigned char                                      UnknownData_YU4M[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ERBP[0x7F];                                    // 0x0449(0x007F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MCU9[0xC];                                     // 0x03EC(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6Y1X[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
