...
public:
	...
	unsigned char                                      UnknownData_409O[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
public:
	float                                              TaskDuration;                                              // 0x0088(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_MQEV[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_72UV[0x8];                                     // 0x0060(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_8E65[0x2];                                     // 0x0062(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P5Y8[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_G1PV[0x3];                                     // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FHangoutSpotId                              ForcedId;                                                  // 0x008C(0x0008) (Edit)
	unsigned char                                      UnknownData_AERB[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_BKB7[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DXZI[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Y15U[0xD0];                                    // 0x00D0(0x00D0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LQE0[0x70];                                    // 0x00D8(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UClass*                                      PetType_Cached;                                            // 0x0148(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	unsigned char                                      UnknownData_0KIE[0x148];                                   // 0x0150(0x0148) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QIZ8[0x20];                                    // 0x08F0(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0L6C[0x4];                                     // 0x0924(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1EH5[0x8];                                     // 0x0938(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_763Q[0x4];                                     // 0x0974(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JNRE[0x54];                                    // 0x0984(0x0054) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_TWLL[0x3];                                     // 0x02C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_09PX[0x3];                                     // 0x02C9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZWCH[0x23];                                    // 0x02D5(0x0023) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UPetPerchComponent*>                  PetPerchComponents;                                        // 0x02F8(0x0010) (ExportObject, ZeroConstructor, ContainsInstancedReference)
	unsigned char                                      UnknownData_L36F[0x10];                                    // 0x0308(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IPK8[0x1E];                                    // 0x031A(0x001E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3ABI[0x10];                                    // 0x0340(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2PHT[0x18];                                    // 0x0508(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6ZXX[0x17];                                    // 0x0551(0x0017) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YE1M[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_MVPD[0x18];                                    // 0x0118(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZDLJ[0x5];                                     // 0x015B(0x0005) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_E557[0x4];                                     // 0x0038(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	unsigned char                                      UnknownData_NDLI[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BXID[0x18];                                    // 0x0090(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_43F7[0x1A8];                                   // 0x0130(0x01A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E6QO[0x50];                                    // 0x02E0(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0S8G[0x30];                                    // 0x0770(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W1JT[0x4];                                     // 0x07A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_938F[0x6F];                                    // 0x0839(0x006F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PQ5O[0x16];                                    // 0x08AA(0x0016) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YGK4[0x10];                                    // 0x02E0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JLVR[0x80];                                    // 0x00D0(0x0080) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_3SCM[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_ASVG[0x28];                                    // 0x00D0(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D8UD[0x50];                                    // 0x0128(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_GC6J[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
