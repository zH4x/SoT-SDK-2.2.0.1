...
struct FClueSite
{
	...
	unsigned char                                      UnknownData_KQN4[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FRestrictedClueType
{
	...
	unsigned char                                      UnknownData_7AT3[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FClueSiteLootRestriction
{
	...
	unsigned char                                      UnknownData_4OS8[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FWeightedDebris
{
	...
	unsigned char                                      UnknownData_R8QI[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              Weight;                                                    // 0x0020(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_66IM[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FSeaClueCreationChoice
{
	...
	unsigned char                                      UnknownData_JVDI[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FEventClueObtained
{
	...
	unsigned char                                      UnknownData_BUQX[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
