...
struct FRopeCatenaryDynamicsParams
{
	...
	unsigned char                                      UnknownData_YDHY[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FRopeStyleParams
{
	...
	unsigned char                                      UnknownData_YU2Z[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FRiggingSystemPulleyParams
{
	...
	unsigned char                                      UnknownData_AE65[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L82T[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FRiggingSystemLineParams
{
	...
	unsigned char                                      UnknownData_PMEG[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (PADDING)
