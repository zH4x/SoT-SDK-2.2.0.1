...
{
public:
	unsigned char                                      UnknownData_F9PU[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FMerchantContract>                   Contracts;                                                 // 0x0030(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_GJDI[0x18];                                    // 0x0040(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V92A[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
