...
public:
	...
	unsigned char                                      UnknownData_6C7G[0x48];                                    // 0x0038(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_J6UY[0x3];                                     // 0x00E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_9I34[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FMovieSceneBindingOverrideData>      BindingData;                                               // 0x0030(0x0010) (Edit, ZeroConstructor)
	unsigned char                                      UnknownData_XXJJ[0x58];                                    // 0x0040(0x0058) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KR50[0x10];                                    // 0x0060(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_07DU[0x368];                                   // 0x0028(0x0368) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2MW6[0x7];                                     // 0x03C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D1GS[0x10];                                    // 0x03E0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneSequencePlaybackSettings         PlaybackSettings;                                          // 0x03F0(0x0028) (Protected)
	unsigned char                                      UnknownData_D31R[0x1E8];                                   // 0x0418(0x01E8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JC8H[0x2];                                     // 0x0082(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AI4Y[0x3];                                     // 0x0095(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_1YQO[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_BOUH[0x6];                                     // 0x02A2(0x0006) MISSED OFFSET (PADDING)
