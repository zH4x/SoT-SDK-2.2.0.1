...
struct FCleanlinessInfo
{
	...
	unsigned char                                      UnknownData_FI21[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_7LLR[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
