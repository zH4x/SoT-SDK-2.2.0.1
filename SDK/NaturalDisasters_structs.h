...
struct FVolcanoSetupDataEmbersEntry
{
	...
	unsigned char                                      UnknownData_W88X[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedVolcanoProjectile
{
	...
	unsigned char                                      UnknownData_HQ5R[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ALGA[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVolcanoTargetChances
{
	...
	unsigned char                                      UnknownData_UFGP[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DYQQ[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FVolcanoStateData
{
	...
	unsigned char                                      UnknownData_V617[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVolcanoTarget
{
	...
	unsigned char                                      UnknownData_YWS9[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I0DH[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FVolcanoTargetCoolDown
{
	...
	unsigned char                                      UnknownData_B9HA[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
