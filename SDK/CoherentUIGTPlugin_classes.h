...
public:
	...
	unsigned char                                      UnknownData_HD6Z[0x18];                                    // 0x0158(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ALW7[0x176];                                   // 0x019A(0x0176) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JN4W[0x3];                                     // 0x0329(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LPGS[0x17];                                    // 0x0331(0x0017) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YBC9[0x18];                                    // 0x00E0(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QPWM[0x8];                                     // 0x00F8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Q78R[0x50];                                    // 0x03D0(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7KBZ[0x80];                                    // 0x0028(0x0080) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_UK7E[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FM13[0x8];                                     // 0x0330(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OGWU[0x90];                                    // 0x04D0(0x0090) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JY4C[0x20];                                    // 0x0410(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_3YT9[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FIZF[0x1];                                     // 0x003F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_US5W[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KZXF[0x20];                                    // 0x0138(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NIHW[0x18];                                    // 0x01E0(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1C7J[0x3];                                     // 0x01FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RL1B[0x1A3];                                   // 0x021D(0x01A3) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_98MX[0x3];                                     // 0x03D5(0x0003) MISSED OFFSET (PADDING)
