...
struct FFinaleReplicationState
{
	...
	unsigned char                                      UnknownData_X03W[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FChangeGlitterBeardVFXStateEvent
{
	...
	unsigned char                                      UnknownData_AFFF[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3U72[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_66KT[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YQWH[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LVLG[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JGHG[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VSBM[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
