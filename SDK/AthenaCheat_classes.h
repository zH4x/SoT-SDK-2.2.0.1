...
public:
	...
	unsigned char                                      UnknownData_D40A[0x28];                                    // 0x0088(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VWIY[0x3C];                                    // 0x00D4(0x003C) MISSED OFFSET (PADDING)
