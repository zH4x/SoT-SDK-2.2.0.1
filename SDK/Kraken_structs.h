...
struct FCoordinatedKrakenSpecialEvent
{
	...
	unsigned char                                      UnknownData_TPWA[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              TimeOffset;                                                // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_QLPN[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenTentacleAction
{
	...
	unsigned char                                      UnknownData_LU2I[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenHeadAction
{
	...
	unsigned char                                      UnknownData_YXBH[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenExplosionEvent
{
	...
	float                                              TimeOffset;                                                // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_F5EU[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FCoordinatedKrakenAction
{
	...
	unsigned char                                      UnknownData_ROKC[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingTentacleAnimationStateParams
{
	...
	unsigned char                                      UnknownData_2GVU[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingTentacleAnimationState
{
	...
	unsigned char                                      UnknownData_7J0L[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingTentacleVFXParams
{
	...
	unsigned char                                      UnknownData_KYUR[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingTentacleParams
{
	...
	unsigned char                                      UnknownData_O8HA[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenWeightedBehaviour
{
	...
	unsigned char                                      UnknownData_C598[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FKrakenBehaviourParams
{
	...
	unsigned char                                      UnknownData_N77D[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentaclesChanceParams
{
	...
	unsigned char                                      UnknownData_FYAK[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentacleParams
{
	...
	unsigned char                                      UnknownData_KXPZ[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenParams
{
	...
	unsigned char                                      UnknownData_0O85[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z978[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenAnimatedTentacleTransitionAnimation
{
	...
	unsigned char                                      UnknownData_M4ST[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenAnimatedTentacleStateAnimationMapping
{
	...
	unsigned char                                      UnknownData_HBGB[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenHeadStateAnimationMapping
{
	...
	class UAnimSequence*                               Animation;                                                 // 0x0008(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                               Loop;                                                      // 0x0010(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_2SMA[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenHeadHitReactAnimations
{
	...
	unsigned char                                      UnknownData_W9QQ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentacleBehaviourActionChances
{
	...
	unsigned char                                      UnknownData_Y8BT[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenTentacleBehaviourParams
{
	...
	unsigned char                                      UnknownData_FRWB[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O1TO[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenPlayerGrabbingHoldingStateTransitionChance
{
	...
	unsigned char                                      UnknownData_GVI7[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenPlayerGrabbingBehaviourParams : public FKrakenTentacleBehaviourParams
{
	...
	unsigned char                                      UnknownData_HOD7[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenServiceSpawnParams
{
	...
	unsigned char                                      UnknownData_GZ32[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	int                                                Weight;                                                    // 0x0000(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_82WY[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3RIQ[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FWeightedProbabilityRangeOfRanges           NumZonesToDamage;                                          // 0x0068(0x0030) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_XQM8[0x8];                                     // 0x0098(0x0008) MISSED OFFSET (PADDING)
...
struct FKrakenShipHittingBehaviourParams
{
	...
	unsigned char                                      UnknownData_ODAX[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenDynamicsStateEvent
{
	...
	unsigned char                                      UnknownData_O4N7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourHealthParams
{
	...
	unsigned char                                      UnknownData_A8OZ[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingBehaviourNamedTransform
{
	...
	unsigned char                                      UnknownData_6FBW[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWarningParams
{
	...
	unsigned char                                      UnknownData_KGAF[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IE2S[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenDynamicsStateFragmentParams
{
	...
	unsigned char                                      UnknownData_N191[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWrapLocationParams
{
	...
	unsigned char                                      UnknownData_BE0E[0xC];                                     // 0x0014(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	float                                              Weight;                                                    // 0x0000(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_62GU[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourWrapParams
{
	...
	unsigned char                                      UnknownData_OJ54[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T952[0xC];                                     // 0x0054(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKrakenShipWrappingBehaviourHeavyAttackParams
{
	...
	unsigned char                                      UnknownData_SGPT[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (PADDING)
...
struct FKrakenShipWrappingBehaviourDamageParams
{
	...
	unsigned char                                      UnknownData_RHAT[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	class UClass*                                      ShipSize;                                                  // 0x0000(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	unsigned char                                      UnknownData_2SZG[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCoordinatedKrakenPhaseAssetEntry
{
	...
	unsigned char                                      UnknownData_K7EQ[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DBTD[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JVMD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4WVM[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_46OD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OMEH[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_E49I[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TCLF[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7D5P[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZGLQ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3BJP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_094F[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8K24[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TX0I[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Q0XN[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventKrakenAnimatedTentacleAnimationStarted
{
	...
	unsigned char                                      UnknownData_LYD7[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_W8GV[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KSDN[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8UFV[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FKrakenDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_F3WR[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
