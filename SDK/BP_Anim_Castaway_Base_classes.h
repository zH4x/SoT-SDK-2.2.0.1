...
public:
	...
	unsigned char                                      UnknownData_4FT3[0x3];                                     // 0x1BE5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FX29[0x2];                                     // 0x1BF2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
