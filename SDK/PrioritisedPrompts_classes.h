...
public:
	...
	unsigned char                                      UnknownData_4ADJ[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9L7K[0xA8];                                    // 0x0050(0x00A8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_GM4N[0x28];                                    // 0x0040(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_R0Z0[0x70];                                    // 0x0028(0x0070) MISSED OFFSET (PADDING)
