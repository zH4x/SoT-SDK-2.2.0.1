...
struct FWwiseBinkTrackMapping
{
	...
	unsigned char                                      UnknownData_ZAAF[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWwiseIOPriorityMappingConfig
{
	...
	unsigned char                                      UnknownData_1JB2[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FWwiseNativeEmitterPoolDensityParams
{
	...
	unsigned char                                      UnknownData_ZUNM[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWwiseAudioReverbPresets
{
	...
	unsigned char                                      UnknownData_YV4D[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWwiseBinkTrackMappings
{
	...
	unsigned char                                      UnknownData_3FVT[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWwiseBinkSettings
{
	...
	unsigned char                                      UnknownData_54DT[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
