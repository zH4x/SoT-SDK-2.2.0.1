...
struct FSlateColor
{
	...
	unsigned char                                      UnknownData_TZ4S[0x1F];                                    // 0x0011(0x001F) MISSED OFFSET (PADDING)
...
struct FSlateBrush
{
	...
	unsigned char                                      UnknownData_6YOS[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LS2Y[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y6QM[0x5];                                     // 0x0063(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8XYU[0x2];                                     // 0x007A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInputEvent
{
	unsigned char                                      UnknownData_WFMY[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EGI4[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
struct FGeometry
{
	unsigned char                                      UnknownData_Y4D8[0x34];                                    // 0x0000(0x0034) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LXEN[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FSlateSound
{
	...
	unsigned char                                      UnknownData_J68Z[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FSlateFontInfo
{
	...
	unsigned char                                      UnknownData_346V[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NSTR[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FFontData
{
	...
	unsigned char                                      UnknownData_AGJH[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCompositeSubFont
{
	...
	unsigned char                                      UnknownData_GSMV[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FCompositeFont
{
	...
	unsigned char                                      UnknownData_1WQ2[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
...
struct FDockTabStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_UGGN[0x4];                                     // 0x06B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInlineTextImageStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_K5BC[0x6];                                     // 0x009A(0x0006) MISSED OFFSET (PADDING)
...
struct FSearchBoxStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_V79E[0x7];                                     // 0x0AF9(0x0007) MISSED OFFSET (PADDING)
...
struct FCheckBoxStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_7QM6[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_KEIK[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_W62Y[0x30];                                    // 0x0028(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6FRR[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KGZO[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2XFB[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TKD8[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FFocusEvent
{
	unsigned char                                      UnknownData_CNA4[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
