...
{
	unsigned char                                      UnknownData_NZS7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FDY7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FSessionServiceLog
{
	...
	unsigned char                                      UnknownData_2TFL[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FSessionServicePong
{
	...
	unsigned char                                      UnknownData_LZOC[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HXIP[0x7];                                     // 0x0089(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QA3O[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
