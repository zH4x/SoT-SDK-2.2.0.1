...
struct FBox
{
	...
	unsigned char                                      UnknownData_V6B4[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FBox2D
{
	...
	unsigned char                                      UnknownData_XZCN[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurvePointFloat
{
	...
	unsigned char                                      UnknownData_D619[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveFloat
{
	...
	unsigned char                                      UnknownData_5RHF[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInterpCurvePointVector2D
{
	...
	unsigned char                                      UnknownData_XSB2[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveVector2D
{
	...
	unsigned char                                      UnknownData_9IUQ[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInterpCurvePointVector
{
	...
	unsigned char                                      UnknownData_8Z2M[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveVector
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_EWJC[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
	float                                              InVal;                                                     // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_K0LQ[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8K3N[0xF];                                     // 0x0041(0x000F) MISSED OFFSET (PADDING)
...
struct FInterpCurveQuat
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_KHNQ[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct FInterpCurvePointTwoVectors
{
	...
	unsigned char                                      UnknownData_MMTB[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveTwoVectors
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_K6JK[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct FInterpCurvePointLinearColor
{
	...
	unsigned char                                      UnknownData_1N8B[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveLinearColor
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_IW1J[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct FTransform
{
	...
	unsigned char                                      UnknownData_57LT[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FVector                                     Scale3D;                                                   // 0x0020(0x000C) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_GJLN[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FDateTime
{
	unsigned char                                      UnknownData_ZK4L[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FTimespan
{
	unsigned char                                      UnknownData_2XQN[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EVF7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FFloatRangeBound
{
	...
	unsigned char                                      UnknownData_KCSK[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	TEnumAsByte<CoreUObject_ERangeBoundTypes>          Type;                                                      // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_7I9M[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
