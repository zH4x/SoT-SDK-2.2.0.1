...
struct FLimbIK
{
	unsigned char                                      UnknownData_7OAT[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FCharacterAnimationIKUpdateParams
{
	...
	unsigned char                                      UnknownData_HUE7[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4F9Y[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       ParentBone;                                                // 0x0034(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_TR48[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_X3Z1[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Z19F[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimationDataStoreAssetWeakReferenceEntry
{
	...
	unsigned char                                      UnknownData_QYC8[0x4];                                     // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FDockableInfo
{
	...
	unsigned char                                      UnknownData_LDDW[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FDocker
{
	unsigned char                                      UnknownData_HKGC[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FActorVelocityData
{
	...
	unsigned char                                      UnknownData_5UZ7[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTransformBlendCurve
{
	...
	unsigned char                                      UnknownData_6Y1K[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0J28[0x7];                                     // 0x0179(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5RUX[0x7];                                     // 0x02F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FRuntimeVectorCurve                         ScaleCurve;                                                // 0x02F8(0x0170) (Edit)
	unsigned char                                      UnknownData_2MXE[0x8];                                     // 0x0468(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YDHD[0x30];                                    // 0x04D0(0x0030) MISSED OFFSET (PADDING)
...
struct FWeightedAnimationData
{
	...
	unsigned char                                      UnknownData_EEC7[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7S17[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EKC6[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_I3EJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventHitReactAnimationRequested
{
	...
	unsigned char                                      UnknownData_ZEBZ[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FHitReactionAnimationState
{
	...
	unsigned char                                      UnknownData_EE63[0x1E];                                    // 0x000A(0x001E) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ODHC[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C3WV[0x77];                                    // 0x0021(0x0077) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XYDQ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FAnimNode_WeightedLoadOnDemandSquencePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_HKGC[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UAL2[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8Y1K[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AX7Y[0xC];                                     // 0x0000(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2OPV[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FCustomAnimationMontageStateMachine
{
	...
	unsigned char                                      UnknownData_VO0S[0xC0];                                    // 0x0018(0x00C0) MISSED OFFSET (PADDING)
