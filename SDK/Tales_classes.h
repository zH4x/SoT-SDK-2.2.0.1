...
{
public:
	unsigned char                                      UnknownData_BXUT[0x40];                                    // 0x0028(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CT39[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Y7Z8[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QK6Y[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9MVO[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UScriptStruct*                               StructForCollector;                                        // 0x0090(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_DBQQ[0x8];                                     // 0x0098(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LOHC[0x38];                                    // 0x00C8(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UCG8[0x8];                                     // 0x05F8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_EKW3[0x3];                                     // 0x0609(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TGXJ[0x4];                                     // 0x061C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_V7WY[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RXH8[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IFBL[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W645[0x10];                                    // 0x0078(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QBG8[0x18];                                    // 0x0098(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_UPEM[0x38];                                    // 0x0050(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UAWV[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    OnCompleted;                                               // 0x0038(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	unsigned char                                      UnknownData_6MM4[0x28];                                    // 0x0040(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NC8U[0x20];                                    // 0x0090(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_UGWQ[0x48];                                    // 0x00C8(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PSBK[0xC8];                                    // 0x0040(0x00C8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RAIB[0x58];                                    // 0x0048(0x0058) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5WRU[0x20];                                    // 0x0048(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Q6V0[0x18];                                    // 0x0070(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4XOH[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SM74[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T8PR[0x18];                                    // 0x0088(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0E05[0x20];                                    // 0x0030(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	uint32_t                                           InstancedLevelIndex;                                       // 0x0068(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_13OA[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YYT0[0x50];                                    // 0x0068(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OFVU[0x18];                                    // 0x0068(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KT9T[0x18];                                    // 0x0070(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_HGC3[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	class ASequencerCutSceneActor*                     SequencerCutSceneActor;                                    // 0x0070(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_KALW[0x28];                                    // 0x0078(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RUBF[0xA8];                                    // 0x0068(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EX2N[0x30];                                    // 0x0068(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_0NU9[0x30];                                    // 0x0070(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_95UP[0x20];                                    // 0x0070(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Y6J0[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_K5LB[0x90];                                    // 0x0068(0x0090) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_S2GO[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_H06G[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8IR2[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MFGV[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_EZEU[0x3];                                     // 0x0071(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IOWO[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SZSG[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FQuestVariableVector                        Location;                                                  // 0x0038(0x0010) (Edit)
...
public:
	...
	unsigned char                                      UnknownData_0PFG[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HORK[0x2];                                     // 0x00BA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_6AVO[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G8NS[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	float                                              Radius;                                                    // 0x0030(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_8THK[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FQuestVariableVector                        Location;                                                  // 0x0038(0x0010) (Edit)
...
public:
	...
	unsigned char                                      UnknownData_GLRA[0x4];                                     // 0x0030(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               MarkAsCritical;                                            // 0x0050(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_VCFV[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       CriticalActorLostMessage;                                  // 0x0058(0x0018) ELEMENT_SIZE_MISMATCH (Edit)
	unsigned char                                      UnknownData_2FVD[0x20];                                    // 0x0051(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData_PDWI[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       CriticalActorLostMessage;                                  // 0x0038(0x0018) ELEMENT_SIZE_MISMATCH (Edit)
	unsigned char                                      UnknownData_PVZE[0x20];                                    // 0x0032(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData_4PHO[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0VO1[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       Feature;                                                   // 0x0054(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_MGFR[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_F422[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (PADDING)
...
public:
	class UTaleQuestArrayEntrySelectionStrategy*       SelectionStrategy;                                         // 0x0068(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_USLI[0x38];                                    // 0x0070(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I4M3[0x118];                                   // 0x00B0(0x0118) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EA6C[0x90];                                    // 0x0040(0x0090) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DVSL[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (PADDING)
