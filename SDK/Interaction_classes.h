...
{
public:
	unsigned char                                      UnknownData_WX93[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0W1S[0x3];                                     // 0x00FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RA5S[0x1];                                     // 0x0103(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T6IM[0x7];                                     // 0x0111(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CUNK[0x8];                                     // 0x05A8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_L74W[0xB8];                                    // 0x05B8(0x00B8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_G6F0[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_NN7R[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UInteractableArea*>                   InteractableAreas;                                         // 0x0038(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData_UQ6D[0x28];                                    // 0x0048(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_03R7[0x8];                                     // 0x05C8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_77VF[0x8];                                     // 0x05D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H53I[0xA0];                                    // 0x05E0(0x00A0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_W54O[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PW1P[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZMFZ[0x8];                                     // 0x03F0(0x0008) MISSED OFFSET (PADDING)
