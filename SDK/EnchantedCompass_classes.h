...
{
public:
	unsigned char                                      UnknownData_MFYP[0x10];                                    // 0x0068(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OQX9[0x20];                                    // 0x0100(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_X9IU[0x28];                                    // 0x0068(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_D2LK[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
