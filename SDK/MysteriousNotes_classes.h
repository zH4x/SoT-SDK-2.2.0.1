...
public:
	...
	unsigned char                                      UnknownData_V4JD[0x20];                                    // 0x0028(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       DefaultBody;                                               // 0x0060(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_XPWX[0x20];                                    // 0x0060(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	unsigned char                                      UnknownData_QDP9[0x28];                                    // 0x03D0(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GZFJ[0x88];                                    // 0x0410(0x0088) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BRUH[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_75RH[0x14E];                                   // 0x00EA(0x014E) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1OE4[0x10];                                    // 0x0770(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_00DZ[0x54];                                    // 0x079C(0x0054) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IY9Y[0x118];                                   // 0x0808(0x0118) MISSED OFFSET (PADDING)
