...
struct FFireGridCellSelection
{
	...
	unsigned char                                      UnknownData_CQO8[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireCellStateParticleTemplate
{
	...
	unsigned char                                      UnknownData_60VU[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZL6A[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZDAK[0x2];                                     // 0x0036(0x0002) MISSED OFFSET (PADDING)
...
struct FFireMesh
{
	...
	unsigned char                                      UnknownData_0KY3[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FFireParticleSpawnData
{
	...
	unsigned char                                      UnknownData_E9MG[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FFireParticleSpawnList
{
	...
	unsigned char                                      UnknownData_Q1BL[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FFireCellDesc
{
	...
	unsigned char                                      UnknownData_9RGO[0x1];                                     // 0x0037(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QZ74[0xF];                                     // 0x0041(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireDefaultVFXSpawnData
{
	...
	unsigned char                                      UnknownData_M45T[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FActorFireDamageParams
{
	...
	unsigned char                                      UnknownData_E75R[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_8GCJ[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FReplicatedFireCellCharringData
{
	...
	unsigned char                                      UnknownData_XYN2[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFireGridCharringManager
{
	...
	unsigned char                                      UnknownData_5HR5[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V6F1[0xA0];                                    // 0x0028(0x00A0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_844Y[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_X5WH[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1CTM[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OQ5E[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MVW2[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_28SH[0x10];                                    // 0x0038(0x0010) MISSED OFFSET (PADDING)
...
struct FFireParticleSystem
{
	...
	unsigned char                                      UnknownData_OQ8N[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FShipFireLightRelativeSpawnDesc : public FFireGridRelativeSpawnDesc
{
	...
	unsigned char                                      UnknownData_7YCK[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FShipFireLight
{
	...
	unsigned char                                      UnknownData_6K6A[0x20];                                    // 0x0070(0x0020) MISSED OFFSET (PADDING)
...
struct FShipFireLightManager
{
	...
	unsigned char                                      UnknownData_TYJB[0x4];                                     // 0x0114(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WZ8M[0x28];                                    // 0x0128(0x0028) MISSED OFFSET (PADDING)
