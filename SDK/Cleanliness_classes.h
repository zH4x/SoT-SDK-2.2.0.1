...
{
public:
	unsigned char                                      UnknownData_7ZRP[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HNP3[0x54];                                    // 0x00F4(0x0054) MISSED OFFSET (PADDING)
