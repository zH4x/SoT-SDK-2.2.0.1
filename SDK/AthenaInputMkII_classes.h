...
{
public:
	unsigned char                                      UnknownData_W4TD[0xD8];                                    // 0x0150(0x00D8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_N46S[0x8];                                     // 0x0228(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PISR[0x20];                                    // 0x0150(0x0020) MISSED OFFSET (PADDING)
