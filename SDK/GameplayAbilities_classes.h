...
{
public:
	unsigned char                                      UnknownData_LTUG[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VMKW[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F1WO[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7GYJ[0x7];                                     // 0x01C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KXCV[0x6];                                     // 0x0242(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UWAQ[0x7];                                     // 0x0269(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U9WU[0x3];                                     // 0x0559(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1I4M[0x6];                                     // 0x0562(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_8L3K[0x40];                                    // 0x0028(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGameplayTagContainer                       AbilityTags;                                               // 0x0068(0x0028) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_HRB2[0x18];                                    // 0x0090(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               bReplicateInputDirectly;                                   // 0x00A8(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_YJ7E[0x27];                                    // 0x00A9(0x0027) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H3LA[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BCU0[0x7];                                     // 0x0199(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CWWN[0x70];                                    // 0x03C8(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WPAP[0x5];                                     // 0x0443(0x0005) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7B0W[0x8];                                     // 0x0128(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8N1S[0x78];                                    // 0x0168(0x0078) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3KGN[0x50];                                    // 0x02A8(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UGameplayAbility*>                    AllReplicatedInstancedAbilities;                           // 0x02F8(0x0010) (ZeroConstructor, Protected)
	unsigned char                                      UnknownData_PPO2[0x1B0];                                   // 0x0308(0x01B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J9XZ[0xA0];                                    // 0x0528(0x00A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MA71[0x18];                                    // 0x05D8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6RHC[0x130];                                   // 0x0A18(0x0130) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<unsigned char>                              BlockedAbilityBindings;                                    // 0x0B48(0x0010) (Net, ZeroConstructor, Transient, Protected)
	unsigned char                                      UnknownData_ZBHR[0x140];                                   // 0x0B58(0x0140) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_45VN[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZGW5[0x18];                                    // 0x0118(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_O4S1[0x18];                                    // 0x0460(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_AKY3[0x10];                                    // 0x0058(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RFC6[0x4];                                     // 0x0078(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D90Q[0x8];                                     // 0x0098(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_DYR2[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_G18N[0x28];                                    // 0x0098(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OJAF[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MNA1[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FEHA[0x18];                                    // 0x0088(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_E6SB[0xF];                                     // 0x03D1(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WYR0[0x30];                                    // 0x0450(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XOPZ[0x7];                                     // 0x0491(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YZG4[0x4];                                     // 0x04AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PAFW[0x1B];                                    // 0x04D1(0x001B) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_CA2U[0x18];                                    // 0x0078(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JXZJ[0x20];                                    // 0x0078(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_43CB[0x20];                                    // 0x0078(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_51WV[0x30];                                    // 0x0078(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_X4FF[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WCZD[0x10];                                    // 0x0078(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_3484[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XSU4[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZJRP[0xC8];                                    // 0x0068(0x00C8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VSVA[0x8];                                     // 0x0140(0x0008) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnApplied;                                                 // 0x0130(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData_NEUB[0x8];                                     // 0x0140(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0IML[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_STQJ[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_3WM7[0x10];                                    // 0x0078(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_R1BR[0x10];                                    // 0x0078(0x0010) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnChange;                                                  // 0x0068(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData_P6IU[0x10];                                    // 0x0078(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SXLE[0x20];                                    // 0x0088(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CKBD[0x10];                                    // 0x0080(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7U73[0x4];                                     // 0x045C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_OZV1[0x4];                                     // 0x04EC(0x0004) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_UESW[0xB];                                     // 0x04F5(0x000B) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_E8ZZ[0x18];                                    // 0x0508(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_IGYE[0x10];                                    // 0x0530(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZJ4Y[0x60];                                    // 0x0100(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UNV6[0xC];                                     // 0x0174(0x000C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YGOZ[0x3];                                     // 0x03E1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XVKU[0x5];                                     // 0x03EB(0x0005) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_U4Q3[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LIRP[0x50];                                    // 0x0038(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5H7I[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_40UE[0x20];                                    // 0x0028(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData_XFDI[0x50];                                    // 0x0038(0x0050) MISSED OFFSET (PADDING)
