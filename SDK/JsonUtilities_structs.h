...
{
	unsigned char                                      UnknownData_WXB4[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FTestTextObject
{
	...
	unsigned char                                      UnknownData_YE33[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       TestTextExport;                                            // 0x0038(0x0018) ELEMENT_SIZE_MISMATCH
	unsigned char                                      UnknownData_ND35[0x20];                                    // 0x0038(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FTestSerializationObject
{
	...
	unsigned char                                      UnknownData_K05L[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
