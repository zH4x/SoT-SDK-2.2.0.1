...
struct FNotificationInputDisplayName
{
	...
	unsigned char                                      UnknownData_W5TW[0x20];                                    // 0x0008(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FIdleTimeTracker
{
	...
	unsigned char                                      UnknownData_VBOA[0x30];                                    // 0x0008(0x0030) MISSED OFFSET (PADDING)
...
struct FPrioritizedCompositeInputHandler
{
	...
	unsigned char                                      UnknownData_9KAD[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FCompositeInputDelegator
{
	...
	unsigned char                                      UnknownData_SL8B[0x50];                                    // 0x0010(0x0050) MISSED OFFSET (PADDING)
