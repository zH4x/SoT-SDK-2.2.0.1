...
struct FPropertyPathSegment
{
	...
	unsigned char                                      UnknownData_IATQ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEventReply
{
	unsigned char                                      UnknownData_AN6J[0xE8];                                    // 0x0000(0x00E8) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G4OL[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_ZMN9[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      UnknownData_LSWG[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FDelegateRuntimeBinding
{
	...
	unsigned char                                      UnknownData_UCPD[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_WSAZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VKAX[0x8];                                     // 0x000C(0x0008) MISSED OFFSET (PADDING)
