...
struct FSeasonRewardEarnedEvent
{
	...
	unsigned char                                      UnknownData_X5OI[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelCompletionEvent
{
	...
	unsigned char                                      UnknownData_2PYY[0x2];                                     // 0x0022(0x0002) MISSED OFFSET (PADDING)
...
struct FSeasonGoalCompletionEvent
{
	...
	unsigned char                                      UnknownData_UF43[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSeasonGoalProgressionEvent
{
	...
	unsigned char                                      UnknownData_9H5H[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTrackedObjectiveProgressUpdateMessage
{
	...
	unsigned char                                      UnknownData_7R79[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_UEU7[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
