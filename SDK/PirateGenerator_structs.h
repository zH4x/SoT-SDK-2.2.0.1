...
struct FPirateDescription
{
	...
	unsigned char                                      UnknownData_ZK6U[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XLAE[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FRadialCoordinate                           BodyShapeCoordinate;                                       // 0x000C(0x0008) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData_CLNO[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GBMB[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlendedSubMeshSpecification
{
	...
	unsigned char                                      UnknownData_IBQY[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMaterialReferenceEntry
{
	...
	unsigned char                                      UnknownData_1NBE[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_65P8[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_43ND[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_42XG[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6O8W[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_54VI[0x18];                                    // 0x0040(0x0018) MISSED OFFSET (PADDING)
...
struct FTextureSwitchGenderEntry
{
	...
	unsigned char                                      UnknownData_DMZG[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FStringAssetReference                       Texture;                                                   // 0x0008(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
struct FTextureSwitchEthnicityEntry
{
	...
	unsigned char                                      UnknownData_RF2T[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FStringAssetReference                       Texture;                                                   // 0x0008(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
struct FIPGTestClass
{
	...
	unsigned char                                      UnknownData_V4PE[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QPJV[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FIPGBlendingMethod
{
	...
	unsigned char                                      UnknownData_DAAC[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FIPGSetGroup
{
	...
	unsigned char                                      UnknownData_F69T[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FIPGBlendRange
{
	...
	unsigned char                                      UnknownData_FQLO[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FIPGSetData
{
	...
	TEnumAsByte<PirateGenerator_EIPGGender>            Gender;                                                    // 0x0008(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<PirateGenerator_EIPGEthnicity>         Ethnicity;                                                 // 0x0009(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_GS4H[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FIPGSetsData
{
	...
	unsigned char                                      UnknownData_TA09[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FIPGData
{
	...
	unsigned char                                      UnknownData_4PRM[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothingSlot
{
	...
	unsigned char                                      UnknownData_K1DA[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FClothingPart
{
	...
	unsigned char                                      UnknownData_RRXR[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (PADDING)
