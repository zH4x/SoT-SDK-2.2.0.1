...
{
public:
	unsigned char                                      UnknownData_LWX3[0x18];                                    // 0x03D0(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OCEU[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QRBY[0x768];                                   // 0x00F0(0x0768) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V3P1[0x18];                                    // 0x0858(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WIOR[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_240F[0x10];                                    // 0x03D8(0x0010) MISSED OFFSET (PADDING)
