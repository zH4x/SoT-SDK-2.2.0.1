...
struct FSeasonIconPopupAsset
{
	...
	unsigned char                                      UnknownData_IDP8[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonGoalPopupAsset
{
	...
	unsigned char                                      UnknownData_508S[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonProgressionUIEventTypeTelemetryFragment
{
	...
	unsigned char                                      UnknownData_2O49[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FNavigationDesc
{
	...
	unsigned char                                      UnknownData_A6S6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEnableMoreButtonEvent
{
	...
	unsigned char                                      UnknownData_KBW9[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSeasonProgressionUITelemetryFragment
{
	...
	unsigned char                                      UnknownData_D1SR[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonNotificationContent
{
	...
	unsigned char                                      UnknownData_NYY9[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FDeedProgressDesc
{
	...
	unsigned char                                      UnknownData_0YG6[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOpenSeasonsMenuEvent
{
	...
	unsigned char                                      UnknownData_YAP5[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       Id;                                                        // 0x0004(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
...
struct FSeasonsPopupEvent
{
	...
	unsigned char                                      UnknownData_XSRS[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
