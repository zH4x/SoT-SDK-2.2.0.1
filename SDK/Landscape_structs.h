...
struct FWeightmapLayerAllocationInfo
{
	...
	unsigned char                                      UnknownData_OM3W[0x5];                                     // 0x000B(0x0005) MISSED OFFSET (PADDING)
...
struct FGrassVariety
{
	...
	unsigned char                                      UnknownData_V5BA[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZICO[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLandscapeSplineSegmentConnection
{
	...
	unsigned char                                      UnknownData_MWQZ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineConnection
{
	...
	unsigned char                                      UnknownData_96CI[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FLayerBlendInput
{
	...
	unsigned char                                      UnknownData_K9G6[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IM6F[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BHRQ[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CYDJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_X6WW[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineMeshEntry
{
	...
	unsigned char                                      UnknownData_WLMZ[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CPC3[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JPX6[0x1];                                     // 0x0037(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_R8D0[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H4HC[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K7PN[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
