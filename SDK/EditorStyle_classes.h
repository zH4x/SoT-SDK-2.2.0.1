...
public:
	...
	unsigned char                                      UnknownData_QDBT[0x3];                                     // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5745[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GFG4[0x1E];                                    // 0x0072(0x001E) MISSED OFFSET (PADDING)
