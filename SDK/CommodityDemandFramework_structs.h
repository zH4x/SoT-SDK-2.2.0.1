...
{
	unsigned char                                      UnknownData_EIHT[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FCommodityRedemptionTrackingModel
{
	...
	unsigned char                                      UnknownData_K4TK[0x5];                                     // 0x0003(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCommodityTrackingModel
{
	...
	unsigned char                                      UnknownData_WOJE[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
